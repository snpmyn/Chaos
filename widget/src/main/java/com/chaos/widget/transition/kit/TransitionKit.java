package com.chaos.widget.transition.kit;
...
import com.chaos.widget.transition.value.SharedElementConstant;
...
public class TransitionKit {
    ...
    private MaterialContainerTransform buildMaterialContainerTransform(AppCompatActivity appCompatActivity, boolean entering) {
        ...
        materialContainerTransform.setAllContainerColors(MaterialColors.getColor(appCompatActivity.findViewById(android.R.id.content), R.attr.colorSurface));
