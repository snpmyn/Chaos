...
import com.chaos.widget.dialog.loading.listener.OnClickToCloseListener;
import com.chaos.widget.dialog.loading.listener.OnDialogCloseListener;
...
public class CanCancelLoadingDialog extends BaseInstanceDialog {
    ...
    protected void initData() {
        ...
        layoutParams.width = DensityUtils.dipToPxByFloat(context, 160);
        layoutParams.height = DensityUtils.dipToPxByFloat(context, 56);
