...
public class CropExecutor {
    ...
    private static UCrop.Options options(Context context) {
        ...
        // Toolbar 色
        options.setToolbarColor(ActivityCompat.getColor(context, R.color.purple_500));
        // 状态栏色
        options.setStatusBarColor(ActivityCompat.getColor(context, R.color.purple_500));
        return options;
    }
}
