...
import com.chaos.util.java.datetime.DateUtils;
...
public class HomePageChildFragment extends BaseFragment {
    ...
    @BindView(R.id.homePageChildFragmentMt)
    MaterialToolbar homePageChildFragmentMt;
    ...
    protected String[] janalyticsBrowseEventParams() {
        return new String[]{"push_browse_account_id", "首页子碎片", "首页子碎片", "HomePageChildFragment-key", "HomePageChildFragment-value"};
    }
