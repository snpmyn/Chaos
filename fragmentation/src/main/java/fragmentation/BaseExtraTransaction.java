...
public abstract class BaseExtraTransaction {
    ...
    final static class BaseExtraTransactionImpl<T extends ISupportFragment> extends BaseExtraTransaction implements DoNotAddToBackStackTransaction {
        ...
        @Override
        public void loadRootFragment(int containerId, @NotNull ISupportFragment toFragment, boolean addToBackStack, boolean allowAnim) {
        ...
        @Override
        public void add(@NotNull ISupportFragment toFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
        ...
        @Override
        public void startDoNotHideSelf(@NotNull ISupportFragment toFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
            mTransactionDelegate.dispatchStartTransaction(getFragmentManager(), fSupport, toFragment, 0, ISupportFragment.STANDARD, TransactionDelegate.TYPE_ADD_WITHOUT_HIDE);
        }

        @Override
        public void startDoNotHideSelf(@NotNull ISupportFragment toFragment, @ISupportFragment.LaunchMode int launchMode) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
        ...
        @Override
        public void start(@NotNull ISupportFragment toFragment, @ISupportFragment.LaunchMode int launchMode) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
        ...
        @Override
        public void startForResult(@NotNull ISupportFragment toFragment, int requestCode) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
        ...
        @Override
        public void startForResultDoNotHideSelf(@NotNull ISupportFragment toFragment, int requestCode) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
        ...
        @Override
        public void startWithPop(@NotNull ISupportFragment toFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
            mTransactionDelegate.startWithPop(getFragmentManager(), fSupport, toFragment);
        }

        @Override
        public void startWithPopTo(@NotNull ISupportFragment toFragment, String targetFragmentTag, boolean includeTargetFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
            mTransactionDelegate.startWithPopTo(getFragmentManager(), fSupport, toFragment, targetFragmentTag, includeTargetFragment);
        }

        @Override
        public void replace(@NotNull ISupportFragment toFragment) {
            toFragment.getSupportDelegate().mTransactionRecord = mRecord;
