package com.chaos.kotlin.widget.banner.indicator
...
import com.chaos.kotlin.util.DensityUtils
import com.chaos.kotlin.widget.banner.IIndicator
import com.chaos.kotlin.widget.banner.IIndicatorInstance
import com.chaos.kotlin.widget.banner.createPaint
import com.chaos.kotlin.widget.banner.resetPaint
import kotlin.properties.Delegates

/**
 * @decs: CrossBarIndicator
 * @author: 郑少鹏
...
class CrossBarIndicator @JvmOverloads constructor(
     ...
     * 指示器宽
     */
    private var mItemWidth: Float = 0.0F

    /**
     * 指示器高
     */
    private var mItemHeight: Float = 0.0F

    /**
     * 指示器间隔
     */
    private var mItemSpace: Float = 0.0F
     ...
     * 指示器圆角半径
     */
    private var mItemRadius: Float = 0.0F
    ...
    private fun initItemRectF() {
        ...
        if (count <= 0) return
        mFirstItemRectF = RectF(0.0F, 0.0F, mItemWidth, mItemHeight)
        // 指示器坐标集
    ...
    override fun onDraw(canvas: Canvas?) {
        super.onDraw(canvas)
        if ((null == canvas) || !::mIndicatorImpl.isInitialized) return
        // 绘背景
    ...
    companion object {
        private const val DEFAULT_ITEM_WIDTH = 24.0F
        private const val DEFAULT_ITEM_HEIGHT = 2.0F
        private const val DEFAULT_ITEM_SPACE = 4.0F
