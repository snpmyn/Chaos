...
public class IntentOther {
    ...
    public static @NotNull Intent getViewIntent(Context context, String authority, File file) {
        ...
        } else if (url.contains(UtilMagic.STRING_DOT_3GP) || url.contains(UtilMagic.STRING_DOT_MPG) || url.contains(UtilMagic.STRING_DOT_MPEG) ||
                url.contains(UtilMagic.STRING_DOT_MPE) || url.contains(UtilMagic.STRING_DOT_MP4) || url.contains(UtilMagic.STRING_DOT_AVI)) {
            // Video files
