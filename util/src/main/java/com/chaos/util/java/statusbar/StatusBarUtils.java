...
public class StatusBarUtils {
    ...
    public static void setColorForSwipeBack(AppCompatActivity appCompatActivity, int color) {
        setColorForSwipeBackCustom(appCompatActivity, color, DEFAULT_STATUS_BAR_ALPHA);
    }
     ...
     * @param statusBarAlpha    状态栏透明度
     */
    private static void setColorForSwipeBackCustom(@NotNull AppCompatActivity appCompatActivity, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
     ...
     * @param statusBarAlpha    状态栏透明度
     */
    private static void setTranslucent(AppCompatActivity appCompatActivity, @IntRange(from = 0, to = 255) int statusBarAlpha) {
    ...
    private static void setColorForDrawerLayout(@NotNull AppCompatActivity appCompatActivity, @NotNull DrawerLayout drawerLayout, @ColorInt int color, @IntRange(from = 0, to = 255) int statusBarAlpha) {
        ...
        if (!(contentLayout instanceof LinearLayout) && (null != contentLayout.getChildAt(1))) {
            contentLayout.getChildAt(1).setPadding(contentLayout.getPaddingLeft(),
                    getStatusBarHeight(appCompatActivity) + contentLayout.getPaddingTop(),
    ...
    public static void setTranslucentForDrawerLayout(AppCompatActivity appCompatActivity, DrawerLayout drawerLayout) {
        setTranslucentForDrawerLayoutCustom(appCompatActivity, drawerLayout, DEFAULT_STATUS_BAR_ALPHA);
    }
     ...
     * @param drawerLayout      DrawerLayout
     */
    private static void setTranslucentForDrawerLayoutCustom(AppCompatActivity appCompatActivity, DrawerLayout drawerLayout, @IntRange(from = 0, to = 255) int statusBarAlpha) {
    ...
    private static @NotNull View createStatusBarView(AppCompatActivity appCompatActivity, @ColorInt int color) {
        return createStatusBarView(appCompatActivity, color, 0);
    }
     ...
     * @return 状态栏矩形条
     */
    private static @NotNull View createStatusBarView(AppCompatActivity appCompatActivity, @ColorInt int color, int alpha) {
        // 绘一状态栏等高矩形
     ...
     * @param dark              深色否
     */
    private static void setMeiZuStatusBarDarkIcon(AppCompatActivity appCompatActivity, boolean dark) {
        if (null != appCompatActivity) {
            try {
                WindowManager.LayoutParams layoutParams = appCompatActivity.getWindow().getAttributes();
